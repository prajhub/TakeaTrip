...
const createRoom = async (req, res, next) => {
    ...
    const {type, roomclass, price, bathroom, roomview, inroomamenities, maxPeople, roomNumbers, kitchenamenities, bedding, inroomrefreshments, photos} = req.body
    ...
    try {
      const newRoom = new Room({type, roomclass, roomNumbers, price, bathroom, roomview, maxPeople, inroomamenities, kitchenamenities, bedding, inroomrefreshments, photos})
