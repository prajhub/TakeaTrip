...
const RoomBody = () => {
  ...
  const handleKitcheAppChange = (event) => {
    ...
    if (isChecked) {
      ...
      setKitchenAppliances(
        kitchenAppliances.filter((name) => name !== appName)
      );
      setValue(
        "kitchenamenities",
        kitchenAppliances.filter((name) => name !== appName)
  ...
  const handleBeddingChange = (event) => {
    ...
    if (isChecked) {
      ...
      setValue(
        "bedding",
        bedding.filter((name) => name !== bedName)
      );
      return;
    }
  ...
  const handleRefreshmentChange = (event) => {
    ...
    if (isChecked) {
      ...
      setValue(
        "inroomrefreshments",
        refreshments.filter((name) => name !== refreshName)
      );
      return;
    }
  ...
  const handleDelete = (index) => {
    // Remove the deleted image from both states
    ...
    <>
      <section className="max-w-[1400px]   mx-auto py-32">
        <form onSubmit={handleSubmit(onSumbit)}>
              ...
              <div className="md:col-span-1 ">
                <div className="px-4 sm:px-0">
                  <p className="mt-1 text-sm text-gray-600">
                    Create a room, add amenities, and set up your rates. You can
            ...
            <div className="md:grid md:grid-cols-3 md:gap-6">
              <div className="md:col-span-1">
                <div className="px-4 sm:px-0">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    Add amenities so travelers know what to expect when booking
                    this room.
                  </p>
                </div>
              </div>
                    ...
                    <div className="col-span-full">
                      <Collapse defaultActiveKey={["1"]}>
                        <Panel header="Bathroom Details" key="1">
                          <div className="p-4">
                            <span className="flex gap-2 flex-row items-center text-gray-700 font-bold mb-2">
                              <FaShower size={20} /> How many bathrooms does it
                              have?
                            </span>
                            <div className="relative">
                              <select
                        ...
                        <Panel header="In-room entertainment" key="3">
                          <div>
                            <span className="font-bold flex flex-row items-center gap-2 mb-2">
                              <RiComputerLine size={20} /> Select entertainment
                              options:
                            </span>
                        ...
                        <Panel header="Kitchen Appliances" key="4">
                          <div>
                            <span className="font-bold flex flex-row items-center gap-2 mb-2">
                              <MdOutlineSoupKitchen size={20} /> Select Kitchen
                              wears:
                            </span>
                            {KitchenAppliances.map((appliance) => (
                              ...
                              >
                                <input
                                  ...
                                  checked={kitchenAppliances.includes(
                                    appliance.name
                                  )}
                        ...
                        <Panel header="Bedding" key="5">
                          <div>
                            <span className="font-bold flex flex-row items-center gap-2 mb-2">
                              <MdOutlineSoupKitchen size={20} /> Select offered
                              bedding:
                            </span>
                            {beddingInfo.map((bed) => (
                              <label
            ...
            <div className="md:grid md:grid-cols-3 md:gap-6">
              <div className="md:col-span-1">
                <div className="px-4 sm:px-0">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    Set up your base rate. This is what’s shown to travelers
                    when they’re searching for rooms. You can update your rates
                    before your property is live.
                  </p>
                </div>
              </div>
              <div className="mt-5 md:col-span-2 md:mt-0">
                    ...
                    <div className="col-span-full">
                      <div className="col-span-3 sm:col-span-2">
                        ...
                        <input
                          ...
                          className=" mt-2 border-gray-400 border py-2 px-4 rounded "
                        />
                        <input type="text" {...register("accoId")} hidden />
                      </div>
                    ...
                    <div className="col-span-full">
                      ...
                      <div className="flex mt-4 flex-row gap-2 items-center bg-gray-300 border p-3">
                        ...
                        <p className="text-sm text-gray-400">
                          You’re done—great work. We’ll show the information
                          below to travelers. Review and edit as needed before
                          you go live.
                        </p>
                      </div>
          ...
          <button class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2  ">
            Create Room
          </button>
        </form>
