  ...
  return (
    <>
         ...
         <div className='border border-solid border-gray-300 p-3 rounded-lg flex justify-between gap-5 mb-20'>
            ...
            <h1 className="text-2xl font-semibold text-primary-700">{item.name}</h1>
        
        <span className="text-xs bg-primary-600 w-max text-white px-3 py-1 rounded-md">Free airport taxi</span>
        ...
        <span className="text-xs  font-bold text-primary-500">Free cancellation </span>
          ...
          You can cancel later, so lock in this great price today!
            ...
            <div className=' flex-1 flex flex-col justify-between'>
                <div className='flex justify-between'>
                    ...
                    <button className='bg-primary-600 text-white p-1 font-bold rounded-none border-0'>8.9</button>
                </div>
                <div className='text-right flex flex-col gap-1'>
                    <span className=' text-xl'>${item.cheapestPrice}</span>
                    <span className='text-xs text-gray-400'>Includes taxes and fees</span>
                    <button onClick={handleSeeAvailabilityClick} className='bg-primary-600 text-white text-center font-bold pt-3 pb-2 border-none rounded cursor-pointer'>See availability</button>
                </div>
            </div>
