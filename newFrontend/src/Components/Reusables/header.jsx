      ...
      <header className=" h-[70px]  border-b border-gray-200  ">
        <nav class="flex justify-between  items-center max-w-[1400px] mx-auto py-2">
          <div className="w-[650px] flex items-center ">
            <div>
              <a href="/" class="flex items-center hidden md:block ">
                <span class="self-center text-3xl font-open-san-normal mr-4 font-semibold whitespace-nowrap ">
                  TakeaTrip
                </span>
              </a>
            </div>
          ...
          <div className="flex items-center mr-4">
            <ul className="hidden md:flex items-center">
              <li className="p-4">
                <a
                  href="/"
                  className="text-blackfont-open-san-normal md:hover:bg-transparent md:hover:text-primary-700"
                >
                  Home
                </a>
              </li>
              <li className="p-4">
                <a
                  href="/stays"
                  className="text-black font-open-san-normal md:hover:bg-transparent md:hover:text-primary-700"
                >
                  Destination
                </a>
              </li>
          ...
          <div
            className={
              isMobileNavOpen
                ? "fixed left-0 top-0 w-[50%] border-r border-r-gray-900 h-full z-20 bg-gray-400 ease-in-out duration-500"
                : "fixed left-[-100%]"
            }
          >
