...
const Features = () => {
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Made for travellers like you</h2>
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">Here at TakeaTrip we focus on bringing the best possible travel experience without compromising anything!</p>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Destination search</h3>
              <p class="text-gray-500 dark:text-gray-400"> Easily search and discover popular and exotic travel destinations.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Accommodation options</h3>
              <p class="text-gray-500 dark:text-gray-400">Choose from a wide range of hotel and accommodation options, from budget-friendly to luxury.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Local experiences</h3>
              <p class="text-gray-500 dark:text-gray-400">Immerse yourself in local culture and activities with our hand-picked, authentic experiences.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400">A user-friendly interface that is easy to navigate, making booking your next adventure a breeze.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Deals and discounts</h3>
              <p class="text-gray-500 dark:text-gray-400">Get exclusive access to special offers and discounts on travel packages.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
